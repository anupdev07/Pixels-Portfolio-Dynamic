...
.login-box a:hover
{
    ...
    <img src="avatar.png" class="avatar">
		...
		<form name="login" method="POST" autocomplete="off">
		   ...
		   <p>User Name</p>
            <input type="text" name="name" placeholder="Enter admin Usernamename" required>
            <p>Password</p>
            ...
            <p id="link">
            <a href="http://localhost/assignment/helpdesk_operator.php/" id="link">
			Do not have an account? </a>  </p> 
			</form>
       </div>
    </body>
</html>
